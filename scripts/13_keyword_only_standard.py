...
CONDITION_NAME = "keyword_standard"
...
def answer_question(llm: LLMClient, question: str, options: Dict[str, str], rows: List[Dict[str, str]]) -> Tuple[str, str]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Keyword-only standard-triple ablation")
    ...
    try:
        for index, item in enumerate(questions, 1):
            ...
            raw_rows, status = graph.keyword_search(analysis.get("keywords", []))
            ...
            records.append({**item, "result": {
                ...
                "retrieval": "keyword_only", "attribute_enhanced": False,
                "keyword_count": len(raw_rows), "keyword_status": status,
    ...
    summary = {
        ...
        "attribute_enhanced_context": False,
    }
